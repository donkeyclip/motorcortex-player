...
class Player {
  constructor(options) {
    ...
    this.settingsPanel.id = "mc-player-settings-panel";
    this.settingsPanel.className = "m-fadeOut";

    this.settingsShowIndicator = document.createElement("li");
    this.settingsShowIndicatorCheckBox = document.createElement("input");
    this.settingsShowIndicatorCheckBox.type = "checkbox";

    this.settingsShowIndicator.id = "mc-player-settings-indicator";
    this.settingsShowIndicator.innerHTML = "<label>Show indicator</label>";

    this.settingsShowIndicator.appendChild(this.settingsShowIndicatorCheckBox);
    ...
    this.settingsSpeed.innerHTML = "<label>Speed</label>";
    ...
    this.mcPlayer.appendChild(this.settingsPanel);
    ...
    const css = `
      ...
      #mc-player-settings-panel li input{
        margin-left: 5px;
      }
      
      #mc-player-settings-panel li label{
        margin: 0px;
      }
