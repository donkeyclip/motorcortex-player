...
module.exports = function (_this) {
  _this.elements.settingsShowIndicator.onclick = function (e) {
    e.preventDefault();
    var checkbox = elid(_this.name + "-show-indicator-checkbox");
    if (checkbox.checked) {
  ...
  _this.elements.settingsPointerEvents.onclick = function (e) {
    e.preventDefault();
    var checkbox = elid(_this.name + "-pointer-events-checkbox");
    if (checkbox.checked) {
      checkbox.checked = false;
  ...
  _this.elements.settingsShowVolume.onclick = function (e) {
    ...
    var checkbox = elid(_this.name + "-show-volume-checkbox");
    if (checkbox.checked) {
      checkbox.checked = false;
  ...
  _this.elements.settingsShowPreview.onclick = function (e) {
    e.preventDefault();
    var checkbox = elid(_this.name + "-show-preview-checkbox");
    if (checkbox.checked) {
      checkbox.checked = false;
