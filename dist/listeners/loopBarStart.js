...
module.exports = _this => {
  ...
  _this.listeners.onCursorMoveLoopStart = e => {
    ...
    const endPosition = _this.elements.loopBar.offsetWidth + _this.elements.loopBar.offsetLeft;
    if (positionX < 0) {
      positionX = 0;
    ...
    const runningBarWidthInPxls = _this.elements.runningBar.offsetWidth - loopBarDeltaX;
